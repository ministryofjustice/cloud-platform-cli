	...
	}{
		{
			...
			fields: fields{
				...
				RequiredEnvVars: RequiredEnvVars{
					...
					github_cloud_platform_concourse_bot_app_id:          "github_cloud_platform_concourse_bot_app_id",
					github_cloud_platform_concourse_bot_installation_id: "github_cloud_platform_concourse_bot_installation_id",
					github_cloud_platform_concourse_bot_pem_file:        "github_cloud_platform_concourse_bot_pem_file",
