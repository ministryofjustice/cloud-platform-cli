...
func addEnvironmentCmd(topLevel *cobra.Command) {
	...
	environmentApplyCmd.Flags().StringVar(&optFlags.TfVersion, "terraform-version", "0.14.8", "[optional] the terraform version to use. [default] 0.14.8")
	...
	environmentPlanCmd.Flags().StringVar(&optFlags.TfVersion, "terraform-version", "0.14.8", "[optional] the terraform version to use. [default] 0.14.8")
